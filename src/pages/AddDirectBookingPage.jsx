...
const AddDirectBooking = () => {
	...
	useEffect(() => {
		const fetchData = async () => {
			try {
				...
				const [storesResponse, packagesResponse] = await Promise.all([
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			const response = await axios.post(
				`${import.meta.env.VITE_BASE_URL}/admin/direct/booking`,
				formData,
				{
					headers: {
						Authorization: `Bearer ${authToken}`,
	...
	return (
		<div className="flex-1 overflow-auto relative z-10">
			<Header title="New Customer Booking" />
			...
			<main className="max-w-4xl mx-auto py-6 px-4 lg:px-8">
				...
				>
					<h3 className="text-xl font-semibold text-gray-100 mb-4">Add New Customer Booking</h3>
					...
					<form onSubmit={handleSubmit} className="space-y-4">
                        <div>
							<label className="block text-sm font-medium text-gray-200 mb-2">Customer Name</label>
							<input
								type="text"
								name="customerName"
                        ...
                        <div>
							<label className="block text-sm font-medium text-gray-200 mb-2">Customer Phone</label>
							<input
								type="text"
								name="customerPhone"
                        ...
                        <div>
							<label className="block text-sm font-medium text-gray-200 mb-2">Customer Email</label>
							<input
								type="email"
								name="customerEmail"
...
export default AddDirectBooking;