...
const AddCustomer = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			const response = await axios.post(`${import.meta.env.VITE_BASE_URL}/customer`, formData, {
				headers: {
	...
	return (
		<div className="flex-1 overflow-auto relative z-10">
			...
			<main className="max-w-4xl mx-auto py-6 px-4 lg:px-8">
				...
				>
					<h3 className="text-xl font-semibold text-gray-100 mb-4">Add New Customer</h3>
