...
const AddEmployeePage = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			const response = await axios.post(`${import.meta.env.VITE_BASE_URL}/admin/employee`, formData, {
				headers: {
					Authorization: `Bearer ${authToken}`,
					"Content-Type": "application/json",
				}
            ...
            if(response.data.valid){
                ...
                setFormData({ name: "", email: "", phone: "", storeId: "" });
                navigate("/employees");
            }else{
			...
			setError(error.response?.data?.error_description || "Failed to create store");
		} finally {
			setLoading(false);
		}
	};
	...
	return (
		<div className="flex-1 overflow-auto relative z-10">
			...
			<main className="max-w-4xl mx-auto py-6 px-4 lg:px-8">
				...
				>
					<h3 className="text-xl font-semibold text-gray-100 mb-4">Add New Employee</h3>
